...
working_data %>%filter(edu != "Other") %>% ggplot(aes(x = edu, y = cogscore)) +
  geom_boxplot() +
  coord_flip()
boxplot(cogscore ~ chronic_mod, data = working_data, xlab = "Composite Cognitive score", horizontal = T)
# boxplot(cogscore ~ life_quality, data = working_data, xlab = "Composite Cognitive score", horizontal = T)
boxplot(cogscore ~ eurod, data = working_data, xlab = "Composite Cognitive score", horizontal = T)
...
fit_summary <- summary(better_fit)
fit_plots <- plot(better_fit)
fit_intervals <- confint(better_fit)
```
