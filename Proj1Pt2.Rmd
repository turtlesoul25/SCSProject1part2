...
forestplot(labeltext = rownames(forest_plot_df), mean = forest_plot_df$Estimate,
           lower = forest_plot_df$CI_lower, upper = forest_plot_df$CI_upper, 
           boxsize = 0.2, xlab = "Coefficient estimate value", col = fpColors(box = "gray", 
           lines = "black"), gpar())
```
